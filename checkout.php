...
if (isset($_POST['submit'])) {
  ...
  $email = $_POST['email'];
   ...
   //insert 
  $sql = "INSERT INTO orders (first_name, last_name, country, adress, city, postcode, phone, email) VALUES (:first_name, :last_name, :country, :adress, :city,  :postcode, :phone, :email)";
                ...
                <form action="#" method="post">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input" name="first_name">
                            ...
                            <div class="checkout__input" >
                                ...
                                <input type="text" name="postcode" placeholder="Postcode ou zip">
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input" >
                                ...
                                <button type="submit" class="site-btn" name="submit" s>PLACE ORDER</button>
